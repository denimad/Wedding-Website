...
const translations = {
  es: {
    ...
    "dresscode-men-intro": "Sugerimos opciones frescas pero formales como el Barong Tagalog o la guayabera mexicana.",
    "dresscode-men-list": `
    ...
    `,
    "hotel-cala-blanca": "",  // hotel names don't translate
    "hotel-casa-azul": "",
    "las-casas-bb": "",
    "hotel-racquet-club": "",
    // The discount code text, if you want to translate or keep as is, example:
    // But you can just keep "[to be confirmed]" in English or translate that part:
    "hotel-discount-text": "<strong>Código de descuento:</strong> [por confirmar]",
    ...
    "rsvp-deadline": "<strong>Por favor confirma antes de enero de 2026</strong>",
...
//     "dresscode-men-intro": "We suggest fresh but formal options such as the Barong Tagalog or the Mexican guayabera.",
//     "dresscode-men-list": `
//       <li><strong>Barong Tagalog</strong> — a traditional Filipino garment made from lightweight fabric with fine embroidery, perfect for warm climates.</li>
//       <li><strong>Guayabera</strong> — a linen or cotton shirt, often embroidered, and also a great option for an outdoor formal event.</li>
//     `,
...
//       } 
//       // ⬇ Change starts here
//       else if (id === "dresscode-men-list") {
//         el.innerHTML = entries[id]; // preserve <li> tags
//       }
//       // ⬆ Change ends here
//       else {
...
function cacheOriginalText() {
  const allIds = Object.keys(translations.es); // all translatable element IDs
  allIds.forEach(id => {
    const el = document.getElementById(id);
    if (el) {
      if (el.tagName === "TITLE") {
